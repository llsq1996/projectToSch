    ...
    <el-row>
      ...
      <el-col  :span="22" :offset="1">
        <el-card >
          <el-breadcrumb separator="/">
            <el-breadcrumb-item :to="{path:'/index'}" ><b style="cursor: pointer;color: goldenrod">&nbsp;&nbsp;首页</b><b> / 商家类别统计</b></el-breadcrumb-item>
          </el-breadcrumb>
        </el-card>
      </el-col>
      <br/>  <br/>  <br/> <br/>
      ...
      <el-col :span="11" :offset="1">
        ...
        <el-table
          ...
          stripe
          style="width: 100%">
          <el-table-column prop="categoryName" label="商家类别" width="200"></el-table-column>
